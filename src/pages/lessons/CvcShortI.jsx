...
const CvcShortI = () => {
  ...
  const wordGroups = {
    '-id': ['bid', 'lid', 'rid'],
    '-im': ['him', 'rim', 'Tim'],
    '-it': ['bit', 'fit', 'hit', 'kit', 'pit'],
    '-in': ['bin', 'din', 'fin', 'kin', 'pin', 'tin', 'win'],
    '-ip': ['dip', 'hip', 'lip', 'nip', 'rip', 'sip', 'tip'],
  };
  ...
  const handleCompleteLesson = () => {
    ...
    toast({
      ...
      description: 'Great job on "CVC Words with Short I". Your progress is saved.',
    });
    navigate('/resources');
  };
    ...
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto">
        ...
        <Card className="reading-card">
          <CardHeader>
            <CardTitle className="text-3xl text-white text-center">CVC Words with Short 'i'</CardTitle>
