...
const CvcShortA = () => {
  ...
  const wordGroups = {
    '-ad': ['bad', 'Dad', 'had', 'lad', 'mad', 'pad', 'sad', 'wad'],
    '-ag': ['bag', 'hag', 'nag', 'rag', 'sag', 'tag', 'wag'],
    '-am': ['dam', 'ham', 'jam', 'ram', 'Sam', 'yam'],
  };
  ...
  const handleCompleteLesson = () => {
    ...
    toast({
      ...
      description: 'Great job on "CVC Words with Short A". Your progress is saved.',
    });
    navigate('/resources');
  };
    ...
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <Card className="reading-card">
          <CardHeader>
            <CardTitle className="text-3xl text-white text-center">CVC Words with Short 'a'</CardTitle>
                    ...
                    {words.map((word) => (
                      ...
                      >
                        <Button
                          ...
                          className={`w-full h-14 text-xl font-semibold flex items-center justify-center transition-all duration-200
