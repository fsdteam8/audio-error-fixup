...
const CvcShortE = () => {
  ...
  const wordGroups = {
    '-ed': ['bed', 'fed', 'led', 'red', 'Ted', 'wed', 'zed'],
    '-eg': ['beg', 'leg', 'peg'],
    '-en': ['Ben', 'hen', 'men', 'pen', 'ten', 'Zen'],
    '-et': ['get', 'let', 'net', 'pet', 'set', 'wet', 'yet'],
  };
  ...
  const handleCompleteLesson = () => {
    ...
    toast({
      ...
      description: 'Great job on "CVC Words with Short E". Your progress is saved.',
    });
    navigate('/resources');
  };
    ...
    <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl mx-auto">
        ...
        <Card className="reading-card">
          <CardHeader>
            <CardTitle className="text-3xl text-white text-center">CVC Words with Short 'e'</CardTitle>
